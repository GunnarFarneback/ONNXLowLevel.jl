# Autogenerated using ProtoBuf.jl v1.0.15 on 2024-07-17T14:29:10.830
# original file: ./onnx.proto3 (proto3 syntax)
...
@enumx Version _START_VERSION=0 IR_VERSION_2017_10_10=1 IR_VERSION_2017_10_30=2 IR_VERSION_2017_11_3=3 IR_VERSION_2019_1_22=4 IR_VERSION_2019_3_18=5 IR_VERSION_2019_9_19=6 IR_VERSION_2020_5_8=7 IR_VERSION_2021_7_30=8 IR_VERSION_2023_5_5=9 IR_VERSION=10
...
function PB.encode(e::PB.AbstractProtoEncoder, x::var"TensorShapeProto.Dimension")
    ...
    elseif x.value.name === :dim_value
        PB.encode(e, 1, x.value[]::Int64)
    elseif x.value.name === :dim_param
        PB.encode(e, 2, x.value[]::String)
    end
...
function PB._encoded_size(x::var"TensorShapeProto.Dimension")
    ...
    if isnothing(x.value);
    elseif x.value.name === :dim_value
        encoded_size += PB._encoded_size(x.value[]::Int64, 1)
    elseif x.value.name === :dim_param
        encoded_size += PB._encoded_size(x.value[]::String, 2)
    end
...
@enumx var"TensorProto.DataType" UNDEFINED=0 FLOAT=1 UINT8=2 INT8=3 UINT16=4 INT16=5 INT32=6 INT64=7 STRING=8 BOOL=9 FLOAT16=10 DOUBLE=11 UINT32=12 UINT64=13 COMPLEX64=14 COMPLEX128=15 BFLOAT16=16 FLOAT8E4M3FN=17 FLOAT8E4M3FNUZ=18 FLOAT8E5M2=19 FLOAT8E5M2FNUZ=20 UINT4=21 INT4=22
...
TensorProto(;dims = Vector{Int64}(), data_type = zero(Int32), segment = nothing, float_data = Vector{Float32}(), int32_data = Vector{Int32}(), string_data = Vector{Vector{UInt8}}(), int64_data = Vector{Int64}(), name = "", doc_string = "", raw_data = UInt8[], external_data = Vector{StringStringEntryProto}(), data_location = var"TensorProto.DataLocation".DEFAULT, double_data = Vector{Float64}(), uint64_data = Vector{UInt64}(), metadata_props = Vector{StringStringEntryProto}()) = TensorProto(dims, data_type, segment, float_data, int32_data, string_data, int64_data, name, doc_string, raw_data, external_data, data_location, double_data, uint64_data, metadata_props)
PB.default_values(::Type{TensorProto}) = (;dims = Vector{Int64}(), data_type = zero(Int32), segment = nothing, float_data = Vector{Float32}(), int32_data = Vector{Int32}(), string_data = Vector{Vector{UInt8}}(), int64_data = Vector{Int64}(), name = "", doc_string = "", raw_data = UInt8[], external_data = Vector{StringStringEntryProto}(), data_location = var"TensorProto.DataLocation".DEFAULT, double_data = Vector{Float64}(), uint64_data = Vector{UInt64}(), metadata_props = Vector{StringStringEntryProto}())
PB.field_numbers(::Type{TensorProto}) = (;dims = 1, data_type = 2, segment = 3, float_data = 4, int32_data = 5, string_data = 6, int64_data = 7, name = 8, doc_string = 12, raw_data = 9, external_data = 13, data_location = 14, double_data = 10, uint64_data = 11, metadata_props = 16)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TensorProto})
    ...
    return TensorProto(dims[], data_type, segment[], float_data[], int32_data[], string_data[], int64_data[], name, doc_string, raw_data, external_data[], data_location, double_data[], uint64_data[], metadata_props[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::TensorProto)
    ...
    !isempty(x.metadata_props) && PB.encode(e, 16, x.metadata_props)
    return position(e.io) - initpos
end
function PB._encoded_size(x::TensorProto)
    ...
    !isempty(x.metadata_props) && (encoded_size += PB._encoded_size(x.metadata_props, 16))
    return encoded_size
end
...
GraphProto(;node = Vector{NodeProto}(), name = "", initializer = Vector{TensorProto}(), sparse_initializer = Vector{SparseTensorProto}(), doc_string = "", input = Vector{ValueInfoProto}(), output = Vector{ValueInfoProto}(), value_info = Vector{ValueInfoProto}(), quantization_annotation = Vector{TensorAnnotation}(), metadata_props = Vector{StringStringEntryProto}()) = GraphProto(node, name, initializer, sparse_initializer, doc_string, input, output, value_info, quantization_annotation, metadata_props)
...
PB.default_values(::Type{GraphProto}) = (;node = Vector{NodeProto}(), name = "", initializer = Vector{TensorProto}(), sparse_initializer = Vector{SparseTensorProto}(), doc_string = "", input = Vector{ValueInfoProto}(), output = Vector{ValueInfoProto}(), value_info = Vector{ValueInfoProto}(), quantization_annotation = Vector{TensorAnnotation}(), metadata_props = Vector{StringStringEntryProto}())
PB.field_numbers(::Type{GraphProto}) = (;node = 1, name = 2, initializer = 5, sparse_initializer = 15, doc_string = 10, input = 11, output = 12, value_info = 13, quantization_annotation = 14, metadata_props = 16)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GraphProto})
    ...
    return GraphProto(node[], name, initializer[], sparse_initializer[], doc_string, input[], output[], value_info[], quantization_annotation[], metadata_props[])
end
...
PB.reserved_fields(::Type{AttributeProto}) = (names = ["v"], numbers = Union{Int,UnitRange{Int}}[12, 16:19])
...
NodeProto(;input = Vector{String}(), output = Vector{String}(), name = "", op_type = "", domain = "", overload = "", attribute = Vector{AttributeProto}(), doc_string = "", metadata_props = Vector{StringStringEntryProto}()) = NodeProto(input, output, name, op_type, domain, overload, attribute, doc_string, metadata_props)
PB.default_values(::Type{NodeProto}) = (;input = Vector{String}(), output = Vector{String}(), name = "", op_type = "", domain = "", overload = "", attribute = Vector{AttributeProto}(), doc_string = "", metadata_props = Vector{StringStringEntryProto}())
PB.field_numbers(::Type{NodeProto}) = (;input = 1, output = 2, name = 3, op_type = 4, domain = 7, overload = 8, attribute = 5, doc_string = 6, metadata_props = 9)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:NodeProto})
    ...
    return NodeProto(input[], output[], name, op_type, domain, overload, attribute[], doc_string, metadata_props[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::NodeProto)
    ...
    !isempty(x.overload) && PB.encode(e, 8, x.overload)
    !isempty(x.attribute) && PB.encode(e, 5, x.attribute)
    !isempty(x.doc_string) && PB.encode(e, 6, x.doc_string)
    !isempty(x.metadata_props) && PB.encode(e, 9, x.metadata_props)
    return position(e.io) - initpos
end
function PB._encoded_size(x::NodeProto)
    ...
    !isempty(x.overload) && (encoded_size += PB._encoded_size(x.overload, 8))
    !isempty(x.attribute) && (encoded_size += PB._encoded_size(x.attribute, 5))
    !isempty(x.doc_string) && (encoded_size += PB._encoded_size(x.doc_string, 6))
    !isempty(x.metadata_props) && (encoded_size += PB._encoded_size(x.metadata_props, 9))
    return encoded_size
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::TypeProto)
    ...
    elseif x.value.name === :tensor_type
        PB.encode(e, 1, x.value[]::var"TypeProto.Tensor")
    elseif x.value.name === :sequence_type
        PB.encode(e, 4, x.value[]::var"TypeProto.Sequence")
    elseif x.value.name === :map_type
        PB.encode(e, 5, x.value[]::var"TypeProto.Map")
    elseif x.value.name === :optional_type
        PB.encode(e, 9, x.value[]::var"TypeProto.Optional")
    elseif x.value.name === :sparse_tensor_type
        PB.encode(e, 8, x.value[]::var"TypeProto.SparseTensor")
    end
...
function PB._encoded_size(x::TypeProto)
    ...
    if isnothing(x.value);
    elseif x.value.name === :tensor_type
        encoded_size += PB._encoded_size(x.value[]::var"TypeProto.Tensor", 1)
    elseif x.value.name === :sequence_type
        encoded_size += PB._encoded_size(x.value[]::var"TypeProto.Sequence", 4)
    elseif x.value.name === :map_type
        encoded_size += PB._encoded_size(x.value[]::var"TypeProto.Map", 5)
    elseif x.value.name === :optional_type
        encoded_size += PB._encoded_size(x.value[]::var"TypeProto.Optional", 9)
    elseif x.value.name === :sparse_tensor_type
        encoded_size += PB._encoded_size(x.value[]::var"TypeProto.SparseTensor", 8)
    end
...
ValueInfoProto(;name = "", var"#type" = nothing, doc_string = "", metadata_props = Vector{StringStringEntryProto}()) = ValueInfoProto(name, var"#type", doc_string, metadata_props)
PB.default_values(::Type{ValueInfoProto}) = (;name = "", var"#type" = nothing, doc_string = "", metadata_props = Vector{StringStringEntryProto}())
PB.field_numbers(::Type{ValueInfoProto}) = (;name = 1, var"#type" = 2, doc_string = 3, metadata_props = 4)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ValueInfoProto})
    ...
    return ValueInfoProto(name, var"#type"[], doc_string, metadata_props[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::ValueInfoProto)
    ...
    !isempty(x.metadata_props) && PB.encode(e, 4, x.metadata_props)
    return position(e.io) - initpos
end
function PB._encoded_size(x::ValueInfoProto)
    ...
    !isempty(x.metadata_props) && (encoded_size += PB._encoded_size(x.metadata_props, 4))
    return encoded_size
end
...
struct FunctionProto <: var"##AbstractFunctionProto"
    ...
    attribute_proto::Vector{<:AttributeProto}
...
FunctionProto(;name = "", input = Vector{String}(), output = Vector{String}(), attribute = Vector{String}(), attribute_proto = Vector{AttributeProto}(), node = Vector{NodeProto}(), doc_string = "", opset_import = Vector{OperatorSetIdProto}(), domain = "", overload = "", value_info = Vector{ValueInfoProto}(), metadata_props = Vector{StringStringEntryProto}()) = FunctionProto(name, input, output, attribute, attribute_proto, node, doc_string, opset_import, domain, overload, value_info, metadata_props)
PB.reserved_fields(::Type{FunctionProto}) = (names = ["since_version", "status"], numbers = Union{Int,UnitRange{Int}}[2, 3])
PB.default_values(::Type{FunctionProto}) = (;name = "", input = Vector{String}(), output = Vector{String}(), attribute = Vector{String}(), attribute_proto = Vector{AttributeProto}(), node = Vector{NodeProto}(), doc_string = "", opset_import = Vector{OperatorSetIdProto}(), domain = "", overload = "", value_info = Vector{ValueInfoProto}(), metadata_props = Vector{StringStringEntryProto}())
PB.field_numbers(::Type{FunctionProto}) = (;name = 1, input = 4, output = 5, attribute = 6, attribute_proto = 11, node = 7, doc_string = 8, opset_import = 9, domain = 10, overload = 13, value_info = 12, metadata_props = 14)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:FunctionProto})
    ...
    attribute_proto = PB.BufferedVector{AttributeProto}()
    node = PB.BufferedVector{NodeProto}()
    doc_string = ""
    opset_import = PB.BufferedVector{OperatorSetIdProto}()
    domain = ""
    ...
    return FunctionProto(name, input[], output[], attribute[], attribute_proto[], node[], doc_string, opset_import[], domain, overload, value_info[], metadata_props[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::FunctionProto)
    ...
    !isempty(x.attribute_proto) && PB.encode(e, 11, x.attribute_proto)
    ...
    !isempty(x.overload) && PB.encode(e, 13, x.overload)
    !isempty(x.value_info) && PB.encode(e, 12, x.value_info)
    !isempty(x.metadata_props) && PB.encode(e, 14, x.metadata_props)
    return position(e.io) - initpos
end
function PB._encoded_size(x::FunctionProto)
    ...
    !isempty(x.attribute_proto) && (encoded_size += PB._encoded_size(x.attribute_proto, 11))
    ...
    !isempty(x.overload) && (encoded_size += PB._encoded_size(x.overload, 13))
    !isempty(x.value_info) && (encoded_size += PB._encoded_size(x.value_info, 12))
    !isempty(x.metadata_props) && (encoded_size += PB._encoded_size(x.metadata_props, 14))
    return encoded_size
end
